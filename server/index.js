...
// Live Classes (LC) booking module - pretty URLs
app.get('/live-classes', (req, res) => res.sendFile(path.join(__dirname, '../public/live-classes-index.html')));
app.get('/live-classes/thank-you', (req, res) => res.sendFile(path.join(__dirname, '../public/live-class-thank-you.html')));
app.get('/live-classes/book/:slotId', (req, res) => res.sendFile(path.join(__dirname, '../public/live-class-book.html')));
// SINGLE_PAGE_V1 — merged hero + slots page. /book URL now redirects to the same teacher page anchor #pick-slot.
app.get('/live-classes/:teacherSlug/book', (req, res) => res.redirect(301, '/live-classes/' + encodeURIComponent(req.params.teacherSlug) + '#pick-slot'));
app.get('/live-classes/:teacherSlug', (req, res) => res.sendFile(path.join(__dirname, '../public/live-classes-teacher-hero.html')));

// ── Public (no-auth) API for landing pages ──
app.use('/api/public', require('./routes/public.routes'));
app.use('/api/lc', require('./routes/lc.routes'));
app.use('/api/homepage-cms', require('./routes/homepage-cms.routes'));
