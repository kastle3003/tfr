(function () {
  ...
  const ITEMS = [
    ...
    { href: '/admin-homepage.html',     label: 'Homepage CMS',        icon: I.cms || I.cms_alt || I.announce },
    { section: 'Live Classes' },
    { href: '/admin-live-classes.html',  label: 'Live Class Bookings', icon: I.announce, subitems: [{ hash: 'teachers', label: 'Teachers' },{ hash: 'raags', label: 'Raags' },{ hash: 'slots', label: 'Slots' },{ hash: 'bookings', label: 'Bookings' },{ hash: 'coupons', label: 'Coupons' }] },
    { section: 'Staff Register' }, // STAFF_REGISTER_V4
    { href: '/staff-register.html?role=teacher',     label: 'Register Teacher',     icon: I.instructor },
    { href: '/staff-register.html?role=coordinator', label: 'Register Coordinator', icon: I.users },
    { href: '/staff-register.html?role=instructor',  label: 'Register Instructor',  icon: I.instructor },
    { href: '/staff-register.html?role=admin',       label: 'Register Admin',       icon: I.profile },
    { section: 'Engagement' },
